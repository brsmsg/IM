...
public class MessageFragment extends Fragment implements SessionContract.View {
    ...
    public void conflict(){
        ...
        SpUtils.saveData(getContext(), Mapper.SP_USERNAME, "");
        SpUtils.saveData(getContext(), Mapper.SP_REM_ISCHECK, false);
        SpUtils.saveData(getContext(), Mapper.SP_AUTO_ISCHECK, false);
